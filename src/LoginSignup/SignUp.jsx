  ...
  return (
   <>
    <div className=' flex border-t-2 w-full'>
      ...
      <div onSubmit={handleSign} className='mt-16 pl-48 w-2/4'>
        <form className='h-96 mt-20'>
          ...
          <input type="password" value={password} onChange={(e)=>setconfirmPass(e.target.value)} className='focus:outline-none border-b-2 pt-8 w-96 pb-2' placeholder='Confirm Password' />
